# old script, was messing around with regex to parse, looking back I could've simplified this greatly
# A hash error with Curl was causing Window's update to fail. 
